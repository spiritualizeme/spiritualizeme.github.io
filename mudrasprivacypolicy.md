...
Our app, **Mudras: Yoga, Meditation**, is a health and wellness application. As required by Google Play's User Data Policy, we fully disclose how we handle health and fitness related data.

### Health Data We Collect

The app may collect and process the following health and fitness related information:

*   Yoga and mudra practice sessions (type, duration, and frequency)
*   Meditation activity logs and session history
*   Breathing exercise activity and duration
*   User wellness goals and preferences set within the app
*   Progress tracking data such as streaks and completed sessions
*   Wellness routine preferences and customizations

### How We Use Health Data

*   To personalize your yoga, mudra, and meditation experience
*   To track your wellness progress and display your practice history
*   To provide content recommendations based on your practice habits
*   To improve app features, content, and overall service quality
*   To send relevant reminders and notifications (only if you have enabled them)
...
All health and fitness data (yoga sessions, meditation history, mudra practice, progress tracking) is stored **exclusively on your local device**. We do not have access to this data and it never leaves your device.
...
### 📱 App
**Mudras: Yoga, Meditation**
Developed by **Spiritualize Me**
Available on [Google Play Store](https://play.google.com/store/apps/details?id=health.yoga.mudras)
