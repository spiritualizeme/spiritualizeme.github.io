...
**Surya Namaskar: Stretching Exercise** is a health and wellness application that provides yoga routines, stretching exercises, and guided sessions.
...
* Any activity within the app (such as selected routines, session progress, or preferences):
  ...
  * Is used only to enhance your experience
...
This data is used only for debugging and improving the Service.
...
However, third-party services may use cookies or similar technologies to improve their services and analytics.
...
Data may be processed by trusted third-party services (listed above) only for:
